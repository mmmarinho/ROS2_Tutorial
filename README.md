...
About 📖
---------
ROS2 tutorials by [Murilo M. Marinho](https://murilomarinho.info/), focusing on the programming practices of successful 
state-of-the-art robotics implementations such as the [SmartArmStack](https://github.com/SmartArmStack) and the [AISciencePlatform](https://github.com/AISciencePlatform).
