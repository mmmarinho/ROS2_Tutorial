...
.. note::
   ...
   Except for the particularities of the :file:`setup.py` file, the way that publishers and subscribers in ROS2 work, i.e. the explanation in this section, does not depend on :program:`ament_python` or :program:`ament_cmake`.
